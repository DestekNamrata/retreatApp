    ...
    return Scaffold(
                ...
                children: [
                  Theme(
                      ...
                      child: Radio<int>(
                        ...
                        fillColor: MaterialStateColor.resolveWith((states) => AppTheme.appColor),
                        onChanged: (int? value) {
                          setState(() {
      ...
      //dropdown
            DropdownButtonHideUnderline(
                child: Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(
                          color: Theme.of(context).unselectedWidgetColor.withOpacity(
                              0.5)),
                    ...
                    child: DropdownButton(
                      ...
                      style: TextStyle(color: Colors.black, fontWeight: FontWeight.w400,
                          fontSize: 14.0,fontFamily: 'Inter-Regular'),
                      items: spinnerItems
                          .map((items) =>
          ...
          Container(),
            ...
            BlocBuilder<ScanAndGetDataBloc,ScanAndGetDataState>(builder: (context,scan){
              return BlocListener<ScanAndGetDataBloc,ScanAndGetDataState>(listener: (context,state){

                if (state is ScanQrCodeSuccess) {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ScanSuccessScreen(msg:state.msg)));
                }
                        ...
                        setState(() {
                          ...
                          if(scanResult!=null)
                          {
                            scanAndGetDataBloc!.add(
                                OnScanQrCode(attendanceType: attendanceType.toString(),
